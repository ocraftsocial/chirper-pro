                                        ...
                                        @foreach($files as $file)
                                            ...
                                            <div class="flex items-center justify-between space-x-2">
                                                <div class="flex items-center space-x-2">
                                                    @if($isImage)
                                                        <a href="{{ asset('storage/' . $file) }}" target="_blank" class="block">
                                                            <img src="{{ asset('storage/' . $file) }}" alt="Chirp Image" class="w-16 h-16 object-cover rounded-lg">
                                                        </a>
                                                    @else
                                                ...
                                                <!-- Download Button -->
                                                <a href="{{ asset('storage/' . $file) }}" download class="text-gray-400 hover:text-gray-800">
